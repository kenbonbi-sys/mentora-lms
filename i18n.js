...
(function () {
  ...
  var dict = {
    vi: {
      ...
      'pm.cf':            'Xuyên suốt quá trình này, MoMoers được khuyến khích thực hành văn hóa <span style="white-space:nowrap"><span class="sig">Cho</span> và <span class="sig">Nhận Phản hồi</span></span> liên tục',
    ...
    en: {
      ...
      'pm.cf':            'Throughout this process, MoMoers are encouraged to practise a culture of <span style="white-space:nowrap"><span class="sig">Give</span> &amp; <span class="sig">Receive Feedback</span></span> continuously',
      'pm.cfEn':          'Continuous Feedback',
